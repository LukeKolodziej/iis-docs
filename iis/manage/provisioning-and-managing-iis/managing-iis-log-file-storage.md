...
1. Download the tool from http://www.erezbenari.com/apps/includes/apps/iislogcleaner.html and save the executable in a folder of your choice on the server (there is no installer).
